<template>
  <div class="relative">
    ...
    <div class="flex flex-wrap lg:flex-row justify-between items-center">
      <div class="">
        <h1 class="admin-h1 my-3">Template</h1>
      </div>
      <div class="relative flex items-center w-8/12 lg:w-1/4 md:w-1/4 justify-end">
        <div class="flex items-center">
          <a :href="url+'/accountant/payroll/template/create'" class="no-underline text-white px-4 my-3 mx-1 flex items-center custom-green py-1 justify-center cursor-pointer">
        ...
        <table class="w-full">
          <thead class="bg-grey-light">
            <tr class="border-b">
              ...
              <th class="text-left text-sm px-2 py-2 text-grey-darker">Template</th>
              <th class="text-left text-sm px-2 py-2 text-grey-darker">Created_by</th>
