      ...
      <div class="relative flex items-center w-8/12 lg:w-1/4 md:w-1/4 justify-end">
                           <div class="w-16 flex items-center">
                                <input type="checkbox" name="checkstatus" id="checkstatus" v-model="checkstatus" class="" @change="statuschange($event)">
                                 <label for="checkstatus" class="tw-form-label mx-1">Paid</label>
                            </div>
        <div class="flex items-center">
          <a :href="url+'/accountant/payroll/payslip/create'" class="no-underline text-white px-4 my-3 mx-1 flex items-center custom-green py-1 justify-center cursor-pointer">
         ...
         <!-- <div class="flex items-center">
          <a :href="url+'/accountant/exportUnpaidpayroll'" class="no-underline text-white px-4 my-3 mx-1 flex items-center custom-green py-1 justify-center cursor-pointer">
            <span class="mx-1 text-sm font-semibold">Export </span>
          </a> 
        </div> -->
        <div class="flex items-center">
          <a :href="url+'/accountant/unpaid/report'" class="no-underline text-white px-4 my-3 mx-1 flex items-center custom-green py-1 justify-center cursor-pointer">
            <span class="mx-1 text-sm font-semibold">Report </span>
          </a> 
        </div>
         <div class="flex items-center">
          <a :href="url+'/accountant/unpaid/bank'" class="no-underline text-white px-4 my-3 mx-1 flex items-center custom-green py-1 justify-center cursor-pointer">
