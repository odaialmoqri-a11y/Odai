...
<div class="video-toolbar bottom-0  z-40">
	<div class="rounded-full">
		<ul class="list-reset flex items-center bg-white rounded-full">
			<li class="w-8 h-8  text-center px-2 py-2 bg-white rounded-full {{Request::segment ('1') == 'video-chat-grid' ? 'active':''}}">
			<a href="{{url('/video-chat-grid')}}" class="flex items-center justify-center w-full h-full">
		<svg class="w-5 h-5 fill-current text-gray-600" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	...
	<g>
		<path d="M452,276H336c-33.084,0-60,26.916-60,60v116c0,33.084,26.916,60,60,60h116c33.084,0,60-26.916,60-60V336
			...
			h116c11.028,0,20,8.972,20,20V452z"/>
						...
						<li class="w-8 h-8  text-center px-2 py-2 rounded-full bg-white {{Request::segment ('1') == 'video-chat-collaboration' ? 'active':''}}">
			<a href="{{url('/video-chat-collaboration')}}" class="flex items-center justify-center w-full h-full">
		<svg class="w-5 h-5 fill-current text-gray-600" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 492.022 492.022" style="enable-background:new 0 0 492.022 492.022;" xml:space="preserve">
<g id="XMLID_607_">
	...
	<path id="XMLID_608_" d="M406.609,1.685H260.308c-18.956,0-34.325,15.369-34.325,34.324c0,18.956,15.369,34.326,34.325,34.326
		...
		C492.022,40,453.706,1.685,406.609,1.685z"/>
			...
			<li class="w-8 h-8  text-center px-2 py-2 rounded-full bg-white {{Request::segment ('1') == 'video-chat-tile' ? 'active':''}}">
			<a href="{{url('/video-chat-tile')}}" class="flex items-center justify-center w-full h-full">
		<svg class="w-5 h-5 fill-current text-gray-600" id="Capa_1" enable-background="new 0 0 374.706 374.706" height="512" viewBox="0 0 374.706 374.706" width="512" xmlns="http://www.w3.org/2000/svg"><path id="path-1_59_" d="m80.294 53.529h294.412v53.529h-294.412z" transform="translate(4 3)"/><path d="m80.294 160.588h267.647v53.529h-267.647z"/><path id="path-1_58_" d="m80.294 267.647h294.412v53.529h-294.412z" transform="translate(4 11)"/><path id="path-2_11_" d="m0 53.529h53.529v53.529h-53.529z" transform="translate(1 3)"/><path id="path-2_10_" d="m0 160.588h53.529v53.529h-53.529z" transform="translate(1 7)"/><path id="path-2_9_" d="m0 267.647h53.529v53.529h-53.529z" transform="translate(1 11)"/></svg>
			
			</a></li>
				<li class="w-8 h-8  text-center px-2 py-2 rounded-full bg-white {{Request::segment ('1') == 'video-chat-presentation' ? 'active':''}}">
			<a href="{{url('/video-chat-presentation')}}" class="flex items-center justify-center w-full h-full">
	<svg class="w-5 h-5 fill-current text-gray-600" viewBox="0 -22 512 511" xmlns="http://www.w3.org/2000/svg"><path d="m512 233.820312-212.777344-233.320312v139.203125h-45.238281c-140.273437 0-253.984375 113.710937-253.984375 253.984375v73.769531l20.09375-22.019531c68.316406-74.851562 164.980469-117.5 266.324219-117.5h12.804687v139.203125zm0 0"/></svg>
